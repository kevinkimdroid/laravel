...
<ul class="nav nav-tabs mb-4" id="gamesTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="well-played-tab" data-bs-toggle="tab" data-bs-target="#well-played" type="button" role="tab" aria-controls="well-played" aria-selected="false">
            <i class="bi bi-star-fill me-1" style="color: #FFD700;"></i>Well-Played
            <span class="badge ms-1" style="background: #FFD700; color: #000000;">{{ $wellPlayedGames->count() }}</span>
        </button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="close-games-tab" data-bs-toggle="tab" data-bs-target="#close-games" type="button" role="tab" aria-controls="close-games" aria-selected="false">
            <i class="bi bi-lightning-charge me-1" style="color: #FFD700;"></i>Close Games
            <span class="badge ms-1" style="background: #FFD700; color: #000000;">{{ $closeGames->count() }}</span>
        </button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="high-scoring-tab" data-bs-toggle="tab" data-bs-target="#high-scoring" type="button" role="tab" aria-controls="high-scoring" aria-selected="false">
            <i class="bi bi-fire me-1" style="color: #FFD700;"></i>High Scoring
            <span class="badge ms-1" style="background: #FFD700; color: #000000;">{{ $highScoringGames->count() }}</span>
        </button>
    </li>
    <li class="nav-item" role="presentation">
                    ...
                    @forelse($allGames as $game)
                        ...
                        <tr style="{{ $isWellPlayed ? 'background-color: rgba(212, 175, 55, 0.1) !important;' : '' }}">
                            <td>
                                ...
                                @if($isWellPlayed)
                                    <i class="bi bi-star-fill ms-1" style="color: #FFD700;" title="Well-Played Game"></i>
                                @endif
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                @if($isClose)
                                    <br><small style="color: #FFD700;"><i class="bi bi-lightning-charge"></i> Close!</small>
                                @endif
                                @if($isHighScoring)
                                    <br><small style="color: #FFD700;"><i class="bi bi-fire"></i> High Scoring!</small>
                                @endif
                            </td>
